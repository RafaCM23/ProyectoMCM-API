...
public class ProfesionalService {
	...
	public List<Profesional> getProfesionales(){
		List<Profesional> todos= profRepo.findAll();
	...
	public void initProfesionales() {
		...
		marta.setEmail("marta@correo.es");marta.setContrasenia("contrasenia123");
		Profesional ej1 = new Profesional("Ej1", "ejemplo1", "emai","tlfn");
